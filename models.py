...
class Thruster:
  ...
  def operationalParams(self, Pa, throttle=1):
    ...
    # Pa = power available for the thruster to use (taken as 10% of actual power available)
...
class VikiThruster(Thruster):
  def __init__(self):
    Thruster.__init__(self, thrust=4.564e-3, isp=6.8249, power=1.1794)
...
class Battery:
  def __init__(self,P,S,cellVoltage,cellCapacity,chargeCurrent,dischargeCurrent):
    ...
    # Number of cells in paralell and series
    self.P = P
    self.S = S
    # Battery Voltage
